"""Class containing all the information the crawler needs to make a decision """
from trainer.resource_identifier import ResourceIdentifier
from enums import CaptchaType, PageType
...
class ParsedData:
    ...
    def __init__(self, page_type: PageType, next_page_button: ResourceIdentifier = None,
                 ...
                 nrof_words_on_page: int = -1, captcha_on_page: bool = False, its_a_captcha_page: bool = False,
                 captcha_type: CaptchaType = None, captcha_location: ResourceIdentifier = None,
                 username_field: ResourceIdentifier = None, password_field: ResourceIdentifier = None,
                 is_badly_formatted: bool = False):
        ...
        self.goto_login_button = goto_login_button
        self.first_thread_page_button = first_thread_page_button
        self.nrof_words_on_page = nrof_words_on_page
        self.captcha_on_page = captcha_on_page
        self.its_a_captcha_page = its_a_captcha_page
        self.captcha_type = captcha_type
        self.captcha_location = captcha_location
        self.username_field = username_field
        self.password_field = password_field
        self.is_badly_formatted = is_badly_formatted
